    ...
    import com.example.javanotes2710.Adapter.NotesListAdapter;
    import com.example.javanotes2710.DataBase.RoomDB;
    ...
    public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
        ...
        public void updateRecycle(List<Notes> notes) {
            ...
            // Создаем компаратор для сортировки заметок
            Comparator<Notes> notesComparator = (note1, note2) -> {
                boolean isPinned1 = note1.isPinned();
                boolean isPinned2 = note2.isPinned();

                // Сначала идут закрепленные заметки
            ...
            // Устанавливаем StaggeredGridLayoutManager
